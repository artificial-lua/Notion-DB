...
import { BlockObjectRequest, CreatePageParameters, CreatePageResponse } from '@notionhq/client/build/src/api-endpoints'
...
export type PageData = Array<BlockObjectRequest>
...
export class DatabaseAPI {
    ...
    private columns: any
    private displayWarning: boolean = true

    constructor(integrationKey: string, databaseId: string, warn: boolean = true) {
        this.displayWarning = warn
    ...
    makeCreateData(createData: CreateData): CreatePageParametersData {
        ...
        if (createData?.properties) {
            const properties = createData.properties
                    ...
                    switch (column.type) {
                        ...
                        default:
                            if (this.displayWarning) {
                                console.warn(`${column.type} is not supported yet.`)
                            }
                            returnData.properties[key] = {
                                name: value as string
                            }
